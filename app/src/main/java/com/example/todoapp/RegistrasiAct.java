    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        Regis.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                ...
                if(Nama.getText().toString().equals("") && Email.getText().toString().equals("") && Pass.getText().toString().equals("") && Repass.getText().toString().equals("")){
                    ...
                    if (!password.equals(repassword)){
                        Toast t = Toast.makeText(getApplicationContext(),"Password dan Re-Password harus sama!",Toast.LENGTH_LONG);
                        t.show();
